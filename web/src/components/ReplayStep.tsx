...
export default function ReplayStep({ step }: ReplayStepProps) {
  switch (step.step_type) {
    ...
    case "file_change":
      return (
        <div className="replay-file-change mr-auto max-w-[80%] rounded-lg border-l-4 border-indigo-400 bg-indigo-50 px-4 py-2 text-sm">
          <div className="font-semibold text-indigo-700">File Change</div>
    ...
    default:
      return (
        <div className="replay-unknown mr-auto max-w-[80%] rounded-lg border-l-4 border-gray-300 bg-gray-50 px-4 py-2 text-sm">
